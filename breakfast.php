...
<div class="row">
	<div class="col col-md-4">
		<div class="card p-2">
  <img class="card-img-top" src="breakfast1.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Breakfast1</h5>
	...
	<div class="col col-md-4">
		<div class="card p-2">
  <img class="card-img-top" src="breakfast2.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Breakfast2</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Book Now</a>
  </div>
</div>
	...
	<div class="col col-md-4">
		<div class="card p-2">
  <img class="card-img-top" src="breakfast3.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Breakfast3</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Book Now</a>
  </div>
</div>
