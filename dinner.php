...
<div class="container-fluid">
	<img src="pic4.jpg" style="width: 100%;height: 100%">
...
<div class="row">
	<div class="col col-md-4">
		<div class="card p-2">
  <img class="card-img-top" src="dinner1.jpeg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">dinner1</h5>
	...
	<div class="col col-md-4">
		<div class="card p-2">
  <img class="card-img-top" src="dinner2.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">dinner2</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Book Now</a>
  </div>
</div>
	...
	<div class="col col-md-4">
		<div class="card p-2">
  <img class="card-img-top" src="dinner3.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">dinner3</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Book Now</a>
  </div>
</div>
